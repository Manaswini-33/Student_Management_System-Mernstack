...
async function seedDB() {
    try {
        ...
        if (!existingAdmin) {
            ...
            // Ensure the existing admin has a hashed password if the user manually broke it
            existingAdmin.password = adminPass;
            existingAdmin.email = existingAdmin.email.toLowerCase();
            await existingAdmin.save();
            console.log("ℹ️ Admin updated to ensure valid hash.");
        }
